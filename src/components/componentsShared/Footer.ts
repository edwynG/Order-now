import { socialNetworks } from "../../utils/context.js";
  ...
  let str: string = `
    <footer class="footer-container">
        ...
        <li class="icon-content">
            <a href="${socialNetworks.discor}" target="_blank" aria-label="Discord" data-social="discord">
        ...
        <li class="icon-content">
            <a href="${socialNetworks.github}" target="_blank" aria-label="GitHub" data-social="github">
            <div class="filled"></div>
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
